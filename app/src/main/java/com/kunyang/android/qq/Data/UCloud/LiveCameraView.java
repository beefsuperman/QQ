package com.kunyang.android.qq.Data.UCloud;
...
//        setShowMode(Mode.ORIGIN);
    ...
    UStreamStateListener mInnerStreamStateListener = new UStreamStateListener() {
        @Override
        public void onStateChanged(State state, Object extra) {
    ...
    UNetworkListener mInnerNetworkStateListener = new UNetworkListener() {
        ...
        @Override
        public void onNetworkStateChanged(State state, Object extra) {
