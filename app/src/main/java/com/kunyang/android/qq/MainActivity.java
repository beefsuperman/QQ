...
public class MainActivity extends AppCompatActivity {
    ...
    // 退出登录
    private Button mSignOutBtn,mStartLiveBtn;
    ...
    private void initView() {
        ...
        mStartLiveBtn=(Button)this.findViewById(R.id.ec_btn_start_live);
        mStartLiveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(MainActivity.this,CreateLiveRoomActivity.class);
                startActivity(i);
            }
        });
    }
