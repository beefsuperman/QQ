package com.kunyang.android.qq;
...
import com.kunyang.android.qq.Data.Restapi.LiveException;
import com.kunyang.android.qq.Data.Restapi.LiveManager;
import com.kunyang.android.qq.Data.UCloud.AVOption;
import com.kunyang.android.qq.Data.UCloud.LiveCameraView;
...
public class LiveAnchorActivity extends LiveBaseActivity {
    ...
    UStreamStateListener mStreamStateListener = new UStreamStateListener() {
        //stream state
        @Override public void onStateChanged(State state, Object o) {
        }

        @Override public void onStreamError(Error error, Object extra) {
            switch (error) {
                case IOERROR:
